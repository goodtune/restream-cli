class APIError(Exception):
    ...
    def _format_message(self) -> str:
        ...
        if self.response_text:
            ...
            response = self.response_text[:200] + "..." if len(self.response_text) > 200 else self.response_text
    ...
    def is_transient(self) -> bool:
        ...
        return (
            self.status_code >= 500 or  # Server errors
            self.status_code == 429 or  # Rate limiting
