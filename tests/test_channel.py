...
def test_list_channels():
    ...
    responses.add("GET", "https://api.restream.io/v1/channels", json=channels, status=200)
...
def test_get_channel():
    ...
    responses.add("GET", "https://api.restream.io/v1/channels/c1", json=channel, status=200)
    session = requests.Session()
    client = RestreamClient(session, token)
